...
function loaddata(){
			...
			function amountOfeach(d){
				...
				if (d.Risk=="homosexual/bisexual") {
					if(d.age_at_infection>0&&d.age_at_infection<=15){
						dataset[0]++;}
					if(d.age_at_infection>15&&d.age_at_infection<=21){
						dataset[6]++;}
					if(d.age_at_infection>21&&d.age_at_infection<=26){
						dataset[12]++;}
				}
				if (d.Risk=="blood products") {
					if(d.age_at_infection>0&&d.age_at_infection<=15){
						dataset[1]++;}
					if(d.age_at_infection>15&&d.age_at_infection<=21){
						dataset[7]++;}
				...
				if (d.Risk=="vertical transmission") {
					if(d.age_at_infection>0&&d.age_at_infection<=15){
						dataset[5]++;
					if(d.age_at_infection>15&&d.age_at_infection<=21){
						dataset[11]++;}
			...
			var data = [
					[//bis 15 Jahre
						...
						{axis:"blood products",value:valuesArray15[1]},
						{axis:"heterosexual",value:valuesArray15[2]},
						{axis:"other",value:valuesArray15[3]},
						{axis:"IVDA",value:valuesArray15[4]},
						{axis:"vertical transmission",value:valuesArray15[5]},
					  ],[//bis 21
						{axis:"homosexual/bisexual",value:valuesArray21[0]},
						{axis:"blood products",value:valuesArray21[1]},
						{axis:"heterosexual",value:valuesArray21[2]},
						{axis:"other",value:valuesArray21[3]},
						{axis:"IVDA",value:valuesArray21[4]},
						{axis:"vertical transmission",value:valuesArray21[5]},
					  ],[//bis 26
						{axis:"homosexual/bisexual",value:valuesArray26[0]},
						{axis:"blood products",value:valuesArray26[1]},
						{axis:"heterosexual",value:valuesArray26[2]},
						{axis:"other",value:valuesArray26[3]},
						{axis:"IVDA",value:valuesArray26[4]},
